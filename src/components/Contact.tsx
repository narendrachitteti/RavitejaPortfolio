        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">ravitejapmv79@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">(+91) 93983 57445</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
              <h4 className="font-bold text-gray-800 mb-2">Open to Opportunities</h4>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center gap-2 font-medium"
              >
                <Send size={18} />
                Send Message
              </button>
